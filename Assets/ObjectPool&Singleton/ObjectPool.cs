...
public class ObjectPool
{
    ...
    // ObjectPool 생성자, 생성시 입력받은대로 세팅 후 초기값만큼 풀을 채운후 ObjectPool을 반환
    ...
    //baseObj가 Addressable로 로드했을경우 메모리 관리를 위한 AsyncOperationHandle 보관용 메서드
    ...
    //ObjectPool에서 오브젝트 호출및 호출 관련 오버로딩
